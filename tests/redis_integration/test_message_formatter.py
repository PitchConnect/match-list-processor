...
class TestValidationResult(unittest.TestCase):
    ...
    def test_validation_result_creation(self):
        ...
        result = ValidationResult(is_valid=True, errors=["Error 1"], warnings=["Warning 1"])
...
class TestMatchUpdateMessageFormatter(unittest.TestCase):
    ...
    def test_format_match_updates_no_changes(self):
        ...
        message = MatchUpdateMessageFormatter.format_match_updates(self.test_matches, no_changes)
    ...
    def test_format_match_updates_change_types(self):
        ...
        message = MatchUpdateMessageFormatter.format_match_updates([], cancellation_changes)
