                ...
                try:
                    ...
                    if len(date_parts) == 3:
                        ...
                        if len(time_parts) == 2:
                            ...
                            event_data = {
                                'match_id': match_id,
                                'summary': f"FOGIS Match: {match_data.get('lag1namn', 'Team 1')} vs {match_data.get('lag2namn', 'Team 2')}",
                                'description': f"""FOGIS Referee Assignment

Home Team: {match_data.get('lag1namn', 'Unknown')}
Away Team: {match_data.get('lag2namn', 'Unknown')}
Competition: {match_data.get('tavlingsnamn', 'Unknown')}
Venue: {match_data.get('arenans_namn', 'Unknown')}
...
Referee Team:
{self._format_referee_list(match_data.get('domaruppdraglista', []))}

Match Facts: https://www.svenskfotboll.se/matchfakta/match?matchId={match_id}

---
Generated by FOGIS Automated System
""",
