...
class MatchComparator:
    ...
    @staticmethod
    def detect_changes(
        previous_matches: MatchDict_Dict, current_matches: MatchDict_Dict
    ...
    def is_match_modified(previous_match: MatchDict, current_match: MatchDict) -> bool:
        ...
        if previous_match.get("lag1lagid") != current_match.get("lag1lagid") or previous_match.get(
            "lag2lagid"
        ) != current_match.get("lag2lagid"):
            return True
